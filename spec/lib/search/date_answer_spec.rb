...
describe "date condition" do
  ...
  describe "#to_condition" do
    describe "#eq" do
      let(:condition) { Search::DateAnswer.new(op: 'eq', v: '1/2/2009') }
    ...
    describe "#lt" do
      let(:condition) { Search::DateAnswer.new(op: 'lt', v: '1/2/2009') }
    ...
    describe "#gt" do
      let(:condition) { Search::DateAnswer.new(op: 'gt', v: '1/2/2009') }
    ...
    describe "#lteq" do
      let(:condition) { Search::DateAnswer.new(op: 'lteq', v: '1/2/2009') }
    ...
    describe "#gteq" do
      let(:condition) { Search::DateAnswer.new(op: 'gteq', v: '1/2/2009') }
