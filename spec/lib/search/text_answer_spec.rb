...
describe "text condition" do
  ...
  it "should raise operator not supported exception" do
    proc {
      Search::TextAnswer.new(op: 'lteq', v: 'george')
    }.must_raise Search::OperatorNotSupported
  end

  describe "#to_condition" do
    describe "#eq" do
      let(:condition) { Search::TextAnswer.new(op: 'eq', v: 'george') }
    ...
    describe "#starts" do
      let(:condition) { Search::TextAnswer.new(op: 'starts', v: 'george',i: 1) }
    ...
    describe "#ends" do
      let(:condition) { Search::TextAnswer.new(op: 'ends', v: 'george',i: 2) }
    ...
    describe "#contains" do
      let(:condition) { Search::TextAnswer.new(op: 'contains', v: 'george',i: 4) }
