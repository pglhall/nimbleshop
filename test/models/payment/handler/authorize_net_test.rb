  ...
  module Handler
    class AuthorizeNetAuthorizeTest < ActiveRecord::TestCase
      setup do
        ...
        @processor = AuthorizeNet.new(@order)
      end
    ...
    class AuthorizeNetRefundTest < ActiveRecord::TestCase
      ...
      test "when refund success" do
        skip("need to fix this.how to send credit card number")

        playcasette('authorize.net/refund-success') do
          assert_equal true, @processor.refund(transaction_gid: @tsx_id)
        end
      ...
      test "when refund fails" do
        ...
        playcasette('authorize.net/refund-failure') do
          assert_equal false, @processor.refund(transaction_gid: @tsx_id)
        end
